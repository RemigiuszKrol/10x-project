# Aplikacja - PlantsPlaner (MVP)

### Główny problem
Planowanie rozmieszczenia oraz dobór roślin ogrodowych jest bardzo trudne. Dzęki wykorzystaniu potencjału i wiedzy AI, w PlantsPlaner możesz łatwo dowiedzieć sie czy jak dana roślina sprawdzi sie w twojej strefie klimatycznej oraz jakie umiejscowienie jej na działce będzie dla niej najdogodniejsze.
...
- Tworzenia bazy wymagań hodowlanych roślin
- Zaawansowanego asystenta przesadzania roślin
- Asystenta tworzenia planów pielęgnacji rośli w ciągu roku

### Kryteria sukcesu
- 90% użytkowników posiada conajmniej jeden w pełni wypełnione plan działki z minimum 5 roślinami 
- 75% użytkowników generuje plan, a nastepnie wprowadza w nim 5 lub więcej roślin na rok