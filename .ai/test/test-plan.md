...
- **Komponenty formularzy** (auth, plans, profile)
  - Walidacja inputów
  - Obsługa submit
  - Wyświetlanie błędów
...
- **Komponenty edytora**
  - GridCanvas (renderowanie komórek, zaznaczanie)
  - SideDrawer (tabs, lista roślin)
  - Modals (potwierdzenia, formularze)

- **Komponenty mapowe**
  - LocationMap (wyświetlanie mapy Leaflet)
  - LocationSearch (geokodowanie, autocomplete)
