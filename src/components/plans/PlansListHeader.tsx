...
export function PlansListHeader({ onCreateNew }: PlansListHeaderProps) {
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
      <div>
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">Moje plany</h1>
        <p className="text-sm text-gray-600 mt-1">Zarządzaj swoimi planami działek ogrodowych</p>
      </div>
