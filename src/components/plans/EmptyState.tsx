...
export function EmptyState({ onCreateNew }: EmptyStateProps) {
  return (
    <div className="bg-white rounded-2xl border border-green-100 shadow-xl p-12">
      <div className="flex flex-col items-center justify-center text-center">
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-full blur-2xl" />
          <div className="relative flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200">
            <FileQuestion className="h-12 w-12 text-green-600" />
          </div>
        </div>
        <h2 className="mt-6 text-2xl font-bold text-gray-900">Brak planów</h2>
        ...
        <div className="mt-8 pt-8 border-t border-green-100 w-full max-w-md">
