...
export function LoadingState() {
  return (
    <div
      className="bg-white rounded-2xl border border-green-100 shadow-xl p-12"
      role="status"
      aria-live="polite"
    ...
    >
      <div className="flex flex-col items-center justify-center">
        <div className="relative">
          ...
          <Loader2 className="relative h-12 w-12 animate-spin text-green-600" aria-hidden="true" />
        </div>
        <p className="mt-6 text-gray-600 font-medium">Ładowanie planów...</p>
      </div>
    </div>
  );
}
